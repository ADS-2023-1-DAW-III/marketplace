        ...
        <nav className="flex flex-col gap-4 mx-2">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center font-poppins font-medium text-lg py-3 pl-10 w-full text-left hover:bg-white hover:text-[#307B8E] hover:stroke-[#307B8E] transition-colors duration-500 stroke-white"
            >
              <svg
                width="22"
                height="22"
              ...
              Serviços prestados
              <svg
                className={`ml-2 w-4 h-4 transition-transform duration-300 ${isSubmenuOpen ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {isSubmenuOpen && (
              <div className="bg-white/10 rounded-md py-2 transition-all duration-300">
                <Link
                  to="/servicos_prestados"
                  className="block px-4 py-2 pl-16 text-white text-sm hover:bg-white hover:text-[#307B8E] transition-colors duration-500"
                >
                  Meus Serviços Prestados
                </Link>
                <Link
                  to="/negociacao_servicos_prestador"
                  className="block px-4 py-2 pl-16 text-white text-sm hover:bg-white hover:text-[#307B8E] transition-colors duration-500"
                >
                  Negociação de Serviços Prestados
                </Link>
              </div>
            )}
          </div>
